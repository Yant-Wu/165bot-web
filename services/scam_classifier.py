...
# --- 【修改點：精煉「網路購物」關鍵字】 ---
# 移除 "包裹", "賣家" 等中性詞彙
# 保留 "一頁式", "拒收", "幽靈包裹", "貨不對版" 等明確的詐騙特徵
SCAM_KEYWORDS_MAP = {
    # --- 這是修改過的行 ---
    "網路購物詐騙": ["一頁式", "拒收", "幽靈包裹", "貨不對版", "私下交易", "臉書廣告", "FB廣告"],
    ...
    "假廣告詐騙": ["廣告", "名人推薦", "一頁式"], # (從網路購物移至此處更精確)
    "釣魚簡訊(惡意連結)詐騙": ["簡訊", "連結", "點擊", "包裹", "電信費", "罰單", "積分", "ETF", "驗證碼"], # "包裹" 在這裡是OK的，因為它和"簡訊" "連結" 一起出現
